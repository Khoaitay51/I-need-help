...
class DepartmentGraphManager:
    ...
    def __init__(
        self,
        base_output_dir: str = "department_graphs",
        semantic_threshold: float = 0.7,
        max_edges_per_node: int = 7,
        retriever_top_k: int = 10,
        retriever_internal_k: int = None,
    ):
        self.base_output_dir = base_output_dir
        self.semantic_threshold = semantic_threshold
        self.max_edges_per_node = max_edges_per_node
        self.retriever_top_k = retriever_top_k
        self.retriever_internal_k = retriever_internal_k or max(retriever_top_k * 3, 10)
        ...
        for dept, docs in dept_documents.items():
            ...
            try:
                ...
                graph_builder = DocumentGraph(
                    ...
                    max_semantic_edges_per_node=self.max_edges_per_node
                )
                ...
                retriever = GraphRoutedRetriever(
                    ...
                    internal_k=self.retriever_internal_k,
                    hop_depth=3,
